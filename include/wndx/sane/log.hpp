...
#warning "fixme - consider rewrite without using exotic char types."
  ...
  void log(char const* file, int line, LL ll, fmt::format_string<Args...> fmt, Args&&... args)
  {
  ...
  template <typename... Args>
  void log(char const* file, int line, LL ll, fmt::wformat_string<Args...> fmt, Args&&... args)
  {
