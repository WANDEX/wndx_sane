...
enum class SIG // NOLINT(performance-enum-size)
{
  HUP      = 1,
  INT      = 2,
  QUIT     = 3,
...
template <>
struct fmt::formatter<wndx::sane::sig::SIG> : formatter<string_view>
{
  // parse is inherited from formatter<string_view>.
  using SIG = wndx::sane::sig::SIG;
  ...
  auto format(SIG sig, FormatContext& ctx) const
  {
    ...
    case SIG::ABRT    : name = "SIGABRT"; break; // or IOT = 6
    ...
    case SIG::POLL    : name = "SIGPOLL"; break; // or IO = 29
    case SIG::PWR     : name = "SIGPWR"; break;
    case SIG::SYS     : name = "SIGSYS"; break;
    case SIG::WTF32   : name = "WTF32"; break; // ?
    case SIG::WTF33   : name = "WTF33"; break; // ?
